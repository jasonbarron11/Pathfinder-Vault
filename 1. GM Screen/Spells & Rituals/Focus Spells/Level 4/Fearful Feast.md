...
==[Uncommon](Uncommon.md)== ==[Fear](Fear.md)== ==[Mental](Mental.md)== ==[Necromancy](Necromancy.md)==
*Source* Pathfinder Release 165: Eyes of Empty Death pg. 65
**Domain** abomination
**Cast** ◄ somatic; **Trigger** A creature within range becomes [Frightened](Frightened.md).
