...
==[Divination](Divination.md)== ==[1 TTRPG/PF2e Wiki/Traits/Light](1%20TTRPG/PF2e%20Wiki/Traits/Light)==
...
**Success** The target is [Dazzled](Dazzled.md) for 1 round.
...
**Critical Failure** As failure, but the target is [Blinded](Blinded.md) for 1 round.

<hr>

**Heightened (+1)** The duration increases by 1 day.
**Heightened (4th)** You ignore the [Concealed](Concealed.md) condition against targets marked by zenith star.