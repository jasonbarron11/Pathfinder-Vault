...
==[Uncommon](Uncommon.md)== ==[Attack](Attack.md)== ==[Cleric](Cleric.md)== ==[Evocation](Evocation.md)== ==[Fire](Fire.md)== ==[1 TTRPG/PF2e Wiki/Traits/Light](1%20TTRPG/PF2e%20Wiki/Traits/Light)==
...
**Critical Success** The beam deals double damage, and the target is [Dazzled](Dazzled.md) for 1 minute.
