...
==[Uncommon](Uncommon.md)== ==[Curse](Curse.md)== ==[Death](Death.md)== ==[Hex](Hex.md)== ==[Necromancy](Necromancy.md)== ==[Witch](Witch.md)==
...
**Curse of Death** (curse) This curse ends immediately when the spell ends; **Stage 1** `dice: 4d6|avg` negative damage and [Fatigued](Fatigued.md) (1 round); **Stage 2** `dice: 8d6|avg` negative damage and fatigued (1 round); **Stage 3** `dice: 12d6|avg` negative damage and fatigued (1 round); **Stage 4** death
