...
==[Uncommon](Uncommon.md)== ==[Cleric](Cleric.md)== ==[Enchantment](Enchantment.md)== ==[Mental](Mental.md)== ==[Nonlethal](Nonlethal.md)==
...
As long as the target is taking [Persistent Damage](Persistent%20Damage.md) from this spell, you gain a +1 status bonus to attack rolls and skill checks against the target.
