...
==[Rare](Rare.md)== ==[Cantrip](Cantrip.md)== ==[Evocation](Evocation.md)== ==[Hex](Hex.md)== ==[Witch](Witch.md)==
...
**Critical Failure** The target takes double damage and is [Sickened](Sickened.md) 1 by the crawling insects. The sickened value can't be reduced below 1 while the spell is active.
