...
==[Uncommon](Uncommon.md)== ==[Bard](Bard.md)== ==[Composition](Composition.md)== ==[Emotion](Emotion.md)== ==[Enchantment](Enchantment.md)== ==[Healing](Healing.md)== ==[Mental](Mental.md)==
...
- The spell attempts to [counteract](Counteracting.md) fear effects on the targets.
