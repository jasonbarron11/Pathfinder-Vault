...
If the creature is taking [Persistent Damage](Persistent%20Damage.md) from multiple sources, you select which one is removed. Against an undead target, you deal `dice: 2d8|avg` positive damage (basic Fortitude save); if it fails the save, it also takes 2 persistent positive damage.
