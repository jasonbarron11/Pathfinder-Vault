...
==[Rare](Rare.md)== ==[Hex](Hex.md)== ==[Mental](Mental.md)== ==[Necromancy](Necromancy.md)== ==[Witch](Witch.md)==
...
**Failure** As success, but if the target doesn't comply, it is [Drained](Drained.md) 1 and takes `dice: 6d8|avg` persistent negative damage.
**Critical Failure** As success, but if the target doesn't comply, it is drained 2, [Doomed](Doomed.md) 1, and takes `dice: 6d8|avg` persistent negative damage. Even if the target completes your commands later, the spell doesn't end until all the conditions end.
