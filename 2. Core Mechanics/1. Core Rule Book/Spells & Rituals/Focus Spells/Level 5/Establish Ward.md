...
Upon Casting the Spell, you can immediately make a single nature's wrath Strike. You are [Quickened](Quickened.md) while inside the ward, and can use the additional action only to make nature's wrath Strikes. You are [Slowed](Slowed.md) 1 while outside the area.
