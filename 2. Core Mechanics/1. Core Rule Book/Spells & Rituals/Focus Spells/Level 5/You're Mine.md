...
==[Uncommon](Uncommon.md)== ==[Emotion](Emotion.md)== ==[Enchantment](Enchantment.md)== ==[Incapacitation](Incapacitation.md)== ==[Mental](Mental.md)== ==[Sorcerer](Sorcerer.md)==
...
**Critical Failure** The target is [Controlled](Controlled.md) for 1 round.
