...
**Failure** As success, and if the target hits a surface, it falls [Prone](Prone.md) and can't Fly, [Levitate](Levitate.md), or otherwise leave the ground for 1 minute.
