...
==[Rare](Rare.md)== ==[Evocation](Evocation.md)== ==[Hex](Hex.md)== ==[Witch](Witch.md)==
...
**Success** The target takes half damage and is [Slowed](Slowed.md) 1 for 1 round. The spell ends.
