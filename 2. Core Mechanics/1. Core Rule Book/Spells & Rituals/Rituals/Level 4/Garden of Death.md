# Garden of Death
#pf2e/ritual/level_4
==[Uncommon](Uncommon.md)== ==[Consecration](Consecration)== ==[Necromancy](Necromancy.md)== ==[Plant](Plant.md)== ==[Poison](Poison.md)==
...
---
Typically associated with the less [Friendly](Friendly.md) fey or druids, this ritual calls all the poisonous, toxic, and venomous plants and animals of an area to congregate in a certain place, creating a beautiful but extravagantly deadly garden.
